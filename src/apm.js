...
module.exports = {
  ...
  getAtomDirectory() {
    return process.env.ATOM_HOME != null
      ? process.env.ATOM_HOME
      : path.join(this.getHomeDirectory(), '.atom')
  },
  ...
  getElectronUrl() {
    return process.env.ATOM_ELECTRON_URL != null
      ? process.env.ATOM_ELECTRON_URL
      : 'https://atom.io/download/electron'
  },

  getAtomPackagesUrl() {
    return process.env.ATOM_PACKAGES_URL != null
      ? process.env.ATOM_PACKAGES_URL
      : `${this.getAtomApiUrl()}/packages`
  },

  getAtomApiUrl() {
    return process.env.ATOM_API_URL != null
      ? process.env.ATOM_API_URL
      : 'https://atom.io/api'
  },
